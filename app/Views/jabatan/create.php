...
<div class="container-fluid">
  <div class="row-fluid ml-4">
    <h1 class="row mt-5">Tambah Data Riwayat Jabatan</h1>
    <form action="/jabatan/save" method="post" enctype="multipart/form-data" class="row">
      ...
      <div class="col-sm-5">
        ...
        <div class="form-group row my-3">
          ...
          <div class="col-sm-9">
            <input type="text" class="form-control <?= ($validation->hasError('nama_jabatan')) ? 'is-invalid' : ''; ?>" id="nama_jabatan" name="nama_jabatan" placeholder="Masukkan nama jabatan" value="<?= old('nama_jabatan') ?>">
            <div class="invalid-feedback">
        ...
        <div class="form-group row my-3">
          ...
          <div class="col-sm-3 mt-2">
            <select class="custom-select <?= $validation->hasError('tanggal_mulai_hari') ? 'is-invalid' : '' ?>" id="tanggal_mulai_hari" name="tanggal_mulai_hari">
              <<?php if (old('tanggal_mulai_hari') != 0) : ?> <?php angkaWithSelected(1, 31, old('tanggal_mulai_hari')); ?> <?php else : ?> <option disabled selected value="0">Hari</option>
                <?php angka(1, 31); ?>
              <?php endif; ?>
            </select>
            <div class="invalid-feedback">
        ...
        <div class="form-group row my-3">
          ...
          <div class="col-sm-3 mt-3">
            <select class="custom-select <?= $validation->hasError('tanggal_selesai_hari') ? 'is-invalid' : '' ?>" id="tanggal_selesai_hari" name="tanggal_selesai_hari">
              <<?php if (old('tanggal_selesai_hari') != 0) : ?> <?php angkaWithSelected(1, 31, old('tanggal_selesai_hari')); ?> <?php else : ?> <option disabled selected value="0">Hari</option>
                <?php angka(1, 31); ?>
              <?php endif; ?>
            </select>
            <div class="invalid-feedback">
