...
<div class="container-fluid">
  <div class="row-fluid ml-4">
    <h1 class="row mt-5">Tambah Data Ketidakhadiran</h1>
    <form action="/ketidakhadiran/save" method="post" enctype="multipart/form-data" class="row">
      ...
      <div class="col-sm-5">
        ...
        <div class="form-group row my-3">
          ...
          <div class="col-sm-9 mt-2">
            <textarea class="form-control" aria-label="With textarea" id="keterangan" name="keterangan" placeholder="Masukkan alasan ketidakhadiran"><?= old('keterangan') ?></textarea>
          </div>
        </div>
