...
<div class="container-fluid">
  <div class="row-fluid ml-4">
    <h1 class="row mt-5">Tambah Data Rekrutmen</h1>
    <form action="/rekrutmen/save" method="post" enctype="multipart/form-data" class="row">
      ...
      <div class="col-sm-5">
        ...
        <div class="form-group row my-3">
          ...
          <div class="col-sm-3">
            <select class="custom-select <?= ($validation->hasError('tgl_apply_hari')) ? 'is-invalid' : ''; ?>" id="tgl_apply_hari" name="tgl_apply_hari">
              <?php if (old('tgl_apply_hari') != 0) : ?>
                <?php angkaWithSelected(1, 31, old('tgl_apply_hari')); ?>
              <?php else : ?>
          ...
          <div class="col-sm-3">
            <select class="custom-select <?= ($validation->hasError('tgl_apply_bulan')) ? 'is-invalid' : ''; ?>" id="tgl_apply_bulan" name="tgl_apply_bulan">
              <?php if (old('tgl_apply_bulan') != 0) : ?>
                <?php bulanWithSelected(old('tgl_apply_bulan')); ?>
              <?php else : ?>
          ...
          <div class="col-sm-3">
            <select class="custom-select <?= ($validation->hasError('tgl_apply_tahun')) ? 'is-invalid' : ''; ?>" id="tgl_apply_tahun" name="tgl_apply_tahun">
              <?php if (old('tgl_apply_tahun') != 0) : ?>
                <?php angkaWithSelected(2021, 1950, old('tgl_apply_tahun')); ?>
              <?php else : ?>
        ...
        <div class="form-group row my-3">
          ...
          <div class="col-sm-9 mt-2">
            <input type="text" class="form-control <?= ($validation->hasError('pendidikan_terakhir')) ? 'is-invalid' : ''; ?>" id="pendidikan_terakhir" name="pendidikan_terakhir" value="<?= old('pendidikan_terakhir') ?>" placeholder="Contoh : SMAN 4 Tangsel">
            <div class="invalid-feedback">
        ...
        <div class="form-group row my-3">
          ...
          <div class="col-sm-9">
            <input type="text" class="form-control <?= ($validation->hasError('nilai_akhir')) ? 'is-invalid' : ''; ?>" id="nilai_akhir" name="nilai_akhir" value="<?= old('nilai_akhir') ?>" placeholder="Contoh : UN 40 atau IPK 3.8">
            <div class="invalid-feedback">
        ...
        <div class="form-group row my-3">
          ...
          <div class="col-sm-9">
            <input type="text" class="form-control <?= ($validation->hasError('no_tlfn')) ? 'is-invalid' : ''; ?>" id="no_tlfn" name="no_tlfn" value="<?= old('no_tlfn') ?>" placeholder="Masukkan nomor yang dapat dihubungi">
            <div class="invalid-feedback">
