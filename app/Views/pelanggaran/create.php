...
<div class="container-fluid">
  <div class="row-fluid ml-4">
    <h1 class="row mt-5">Tambah Data Pelanggaran</h1>
    <form action="/pelanggaran/save" method="post" enctype="multipart/form-data" class="row">
      ...
      <div class="col-sm-5">
        ...
        <div class="form-group row my-3">
          ...
          <div class="col-sm-9 mt-2">
            <textarea class="form-control <?= $validation->hasError('keterangan') ? 'is-invalid' : '' ?>" aria-label="With textarea" id="keterangan" name="keterangan" placeholder="Masukkan keterangan pelanggaran"><?= old('keterangan') ?></textarea>
            <div class="invalid-feedback">
