...
$tanggal_mulai_hari = (int)substr($event['tgl_mulai'], 8, 2);
$tanggal_mulai_bulan = (int)substr($event['tgl_mulai'], 5, 2);
$tanggal_mulai_tahun = (int)substr($event['tgl_mulai'], 0, 4);

$tanggal_selesai_hari = (int)substr($event['tgl_selesai'], 8, 2);
$tanggal_selesai_bulan = (int)substr($event['tgl_selesai'], 5, 2);
$tanggal_selesai_tahun = (int)substr($event['tgl_selesai'], 0, 4);

?>

<div class="container-fluid">
    <div class="row-fluid ml-4">
        <h1 class="row mt-5">Edit Data event</h1>
        <form action="/event/update/<?= $event['id'] ?>" method="post" enctype="multipart/form-data" class="row">
            ...
            <div class="col-sm-5">
                ...
                <div class="form-group row my-3">
                    ...
                    <div class="col-sm-9 mt-2">
                        <textarea class="form-control <?= $validation->hasError('nama') ? 'is-invalid' : '' ?>" aria-label="With textarea" id="nama" name="nama" placeholder="Masukkan nama event"><?= $event['nama'] ?></textarea>
                ...
                <div class="form-group row my-3">
                    ...
                    <div class="col-sm-9 mt-2">
                        <textarea class="form-control" aria-label="With textarea" id="lokasi" name="lokasi" placeholder="Masukkan lokasi event"><?= $event['lokasi'] ?></textarea>
                    </div>
                </div>
                ...
                <div class="form-group row my-3">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control <?= ($validation->hasError('pemasukan')) ? 'is-invalid' : ''; ?>" id="pemasukan" name="pemasukan" placeholder="Contoh : 1000000" value="<?= $event['pemasukan'] ?>">
                        <div class="invalid-feedback">
                ...
                <div class="form-group row my-3">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control <?= ($validation->hasError('pengeluaran')) ? 'is-invalid' : ''; ?>" id="pengeluaran" name="pengeluaran" placeholder="Contoh : 1000000" value="<?= $event['pengeluaran'] ?>">
                        <div class="invalid-feedback">
                ...
                <div class="form-group row my-3">
                    <div class="col">
                        ...
                        <a href="/event/delete/<?= $event['id'] ?>" class="btn btn-danger ml-2">Hapus</a>
                    </div>
                </div>
